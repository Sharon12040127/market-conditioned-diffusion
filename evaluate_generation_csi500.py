...
def main():
    ...
    print("生成MCD样本...")
    from downstream.train_csi500 import generate_augmented_data_by_regime, distribution_aware_augmentation, CONFIG
    cfg = CONFIG.copy()
    ...
    from downstream.train_csi500 import generate_unconditional_diffusion
    ...
    df_res.to_csv("downstream/results/generation_quality_csi500.csv")
    print("\n✅ 已保存到 downstream/results/generation_quality_csi500.csv")
