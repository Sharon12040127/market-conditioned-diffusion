...
df_train = pd.read_parquet("data/processed/csi300_train_with_regime.parquet")
df_val   = pd.read_parquet("data/processed/csi300_val_with_regime.parquet")
df_test  = pd.read_parquet("data/processed/csi300_test_with_regime.parquet")
...
with open("downstream/results/regime_distribution.json", "w") as f:
    json.dump(result, f, indent=2)
print("\n✅ 已保存到 downstream/results/regime_distribution.json")