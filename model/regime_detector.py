...
if __name__ == "__main__":
    ...
    detector.plot(
        save_path="data/figures/regime_detection.png"
    )
    ...
    for split, (s, e) in splits.items():
        src = f"data/processed/csi300_{split}.parquet"
    ...
    for split, (s, e) in splits.items():
        ...
        out_path = (
            f"data/processed/"
            f"csi300_{split}_with_regime.parquet"
        )
    ...
    detector.save(
        "data/models/regime_detector.pkl"
    )
